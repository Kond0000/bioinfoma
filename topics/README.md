...
このディレクトリは、RNA-seq学習をトピック単位で整理したものです。

## 読み方

1. 番号の若いトピックから順に進める
2. 各 `README.md` で目的とゴールを確認する
3. `notebooks/` の Colab ノートブックを開く
4. 出てきた図や表を見て理解を言語化する

## トピック一覧

### 01 Count Matrix QC

入口です。count matrix を読み込み、サンプルごとの総カウント数を確認します。  
詳細: [01_count_matrix_qc/README.md](01_count_matrix_qc/README.md)

### 02 Normalization

生の count を比較しやすい形に変換します。  
詳細: [02_normalization/README.md](02_normalization/README.md)

### 03 Exploratory Analysis

PCAやヒートマップでデータ全体の構造を見ます。  
